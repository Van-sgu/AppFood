...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [206 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2402816, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 26843904; uint32_t buffer_offset
	}, ; 203: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 27015936; uint32_t buffer_offset
	}, ; 204: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2148352, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 27037472; uint32_t buffer_offset
	} ; 205: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 29185824, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [29185824 x i8] zeroinitializer, align 16
